    ...
    <nav className="absolute w-full z-10 bg-black/45 border-b border-orange-400 ">
      <div className="container mx-auto px-2 py-3 flex justify-between items-center">
        ...
        <div className="hidden md:flex space-x-1">
          ...
          <Link href="/es/payments" className="text-white hover:text-orange-300 px-3 py-2">
          {t("payments")}
          </Link>
          <Link href="/es/contact" className="text-white hover:text-orange-300 px-3 py-2">
          {t("contact")}
          </Link>
          <LocaleSwitcher />
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          {/* <Link href="/en" className="text-white hover:text-orange-300">
            🇺🇸 EN
          </Link>
          <Link href="/es" className="text-white hover:text-orange-300">
            🇪🇸 ES_ES
          </Link> */}
          <div className="hidden md:flex items-center space-x-2 text-white">
            <Link href="/es/search" aria-label="Search">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
              </svg>
            </Link>
            <Link href="/es/facebook" aria-label="Facebook">
            ...
            <Link href="/es/instagram" aria-label="Instagram">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <Link href="/es/twitter" aria-label="Twitter">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
