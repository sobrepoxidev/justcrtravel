...
const Navbar = () => {
  ...
  return (
    <nav className="absolute w-full z-10 bg-black/45 border-b border-orange-400">
      <div className="mx-auto px-4 sm:px-10 flex items-center justify-between h-24 sm:h-28">
        ...
        <div className="hidden md:flex items-center justify-center flex-1 space-x-4">
          <Link href="/" className="text-white hover:text-orange-300 flex items-center gap-x-1">
            <FaHome />{t("home")}
          </Link>
          <ToursDropdown />
          <Link href="/en/destinations" className="text-white hover:text-orange-300">
            {t("destinations")}
          </Link>
          <ServicesDropdown />
          <Link href="/en/about-us" className="text-white hover:text-orange-300">
            {t("about")}
          </Link>
          <Link href="/en/payments" className="text-white hover:text-orange-300">
            {t("payments")}
          </Link>
          <Link href="/en/contact" className="text-white hover:text-orange-300">
            {t("contact")}
          </Link>
          <LocaleSwitcher />
        </div>
