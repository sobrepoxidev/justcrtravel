    ...
    <div>
      ...
      <section className="relative w-full min-h-screen flex items-center justify-center">
        ...
        <div className="relative max-w-4xl px-4 text-center text-white space-y-4">
          ...
          <Link
            href="/contact"
            className="inline-block mt-4 border-2 border-green-400 text-green-400 hover:bg-green-300/20 hover:text-green-500 transition-colors duration-300 px-8 py-3"
          >
            {t("moreInfo")}
          </Link>
        </div>
