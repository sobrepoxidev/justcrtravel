...
export default function OthersServices() {
  const t = useTranslations("othersServices");
  const imgsrc = "/other-services/study_cover.jpg";

  return (
    <main className="relative min-h-screen bg-gradient-to-br from-teal-50 via-white to-cyan-50">
      <Navbar />
            ...
            <div className="p-6 sm:p-8 lg:p-12 flex flex-col justify-center">
              <div className="space-y-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-6">
                  <Link
                    href="/contact"
                    className="inline-flex items-center justify-center px-6 py-3 bg-gradient-to-r from-teal-500 to-cyan-500 text-white font-medium rounded-xl hover:from-teal-600 hover:to-cyan-600 transition-all duration-300 transform hover:scale-105 shadow-lg"
                  >
                  ...
                  <a
                    href="https://wa.me/50660252461?text=Hola,%20me%20interesa%20información%20sobre%20otros%20servicios"
                    target="_blank"
