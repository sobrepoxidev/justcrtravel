...
export default function Cultural() {
    ...
    const culturalKeys = ["nightLife", "cities", "parks", "indigenous"];
            ...
            <div className="max-w-4xl mx-auto px-4 pt-20 sm:pt-28 pb-8">
                ...
                <div className="space-y-6">
                    {culturalKeys.map((key, index) => {
                        ...
                        return (
                            <div key={key} className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                                <div className="flex flex-col md:flex-row">
                                    ...
                                    <div className="md:w-3/5 p-6 flex flex-col justify-between">
                                        ...
                                        <div className="mt-4">
                                            <a
                                                href="https://wa.me/50660252461?text=Hola,%20me%20interesa%20información%20sobre%20tours%20culturales"
                                                target="_blank"
                ...
                {/* Call to Action */}
                <div className="mt-12 text-center bg-gradient-to-r from-purple-500 to-orange-500 rounded-2xl p-8 text-white">
                    <h3 className="text-xl sm:text-2xl font-bold mb-4">¿Listo para explorar la cultura costarricense?</h3>
                    <p className="text-purple-100 mb-6">Descubre la riqueza cultural de Costa Rica con nuestros tours especializados</p>
                    <a
                        href="https://wa.me/50660252461?text=Hola,%20quiero%20conocer%20más%20sobre%20los%20tours%20culturales%20en%20Costa%20Rica"
                        target="_blank"
                        rel="noopener noreferrer"
